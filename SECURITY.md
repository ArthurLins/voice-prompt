...
Do not publish API keys, personal transcripts, recordings or exploitable vulnerability details in public issues.

For a sensitive vulnerability, contact the repository owner privately using a contact channel they publish on their GitHub profile. If GitHub's private vulnerability reporting is enabled for this repository, use **Security → Report a vulnerability**. This document does not imply that the repository setting is enabled.
